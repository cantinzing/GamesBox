...
begin
  ...
  Cmd := Cmd + 'Add-AppxPackage -Path ''{tmp}\WinAppSDK\Microsoft.WindowsAppRuntime.DDLM.1.7.msix'' -ForceApplicationShutdown; ';
  Cmd := Cmd + 'Add-AppxPackage -Path ''{tmp}\WinAppSDK\Microsoft.WindowsAppRuntime.Singleton.1.7.msix'' -ForceApplicationShutdown; ';
  Cmd := Cmd + 'Add-AppxPackage -Path ''{tmp}\WinAppSDK\Microsoft.WindowsAppRuntime.Main.1.7.msix'' -ForceApplicationShutdown; ';
  Cmd := Cmd + 'Add-AppxPackage -Path ''{tmp}\WinAppSDK\Microsoft.WindowsAppRuntime.1.7.msix'' -ForceApplicationShutdown"';
